        ...
        <div className="responsive-grid-3" style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: 20 }}>
          {[
            ...
            },
            {
              icon: '💳',
              title: 'Pay in ₹, not $',
              desc: 'Razorpay native. UPI, cards, net banking — all supported. No conversion rate surprises. Plans start at ₹1,999/month.',
              color: '#E1306C',
            },
            {
              icon: '⚡',
      ...
      <section style={{ position: 'relative', zIndex: 1, padding: '80px 5%', background: 'rgba(255,255,255,0.015)', borderTop: '1px solid rgba(255,255,255,0.06)', borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
        <div style={{ maxWidth: 900, margin: '0 auto' }}>
          ...
          <div className="responsive-grid-4" style={{ display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', gap: 16 }}>
            {[
              { name: 'Free', price: '₹0', period: 'forever', posts: '3 posts/mo', credits: '25 AI credits', platforms: '1 platform', cta: 'Start free', highlight: false },
              { name: 'Creator', price: '₹1,999', period: '/month', posts: '100 posts/mo', credits: '400 AI credits', platforms: '3 platforms', cta: 'Get Creator', highlight: false },
              { name: 'Pro', price: '₹4,999', period: '/month', posts: '500 posts/mo', credits: '2,000 AI credits', platforms: '5 platforms', cta: 'Get Pro', highlight: true },
